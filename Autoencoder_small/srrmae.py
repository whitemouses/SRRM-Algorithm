...
from ae.trainer_srrmae import SRRMAEBatchTrainer
...
def main():
    ...
    parser.add_argument('--outdir', default='./output/srrmae/', help='directory to output images and model checkpoints')
    ...
    trainer = SRRMAEBatchTrainer(model, optimizer, distribution_fn, device=device)
